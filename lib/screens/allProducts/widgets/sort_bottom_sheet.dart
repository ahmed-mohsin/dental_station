...
class AllProductsSortBottomSheet extends StatelessWidget {
  const AllProductsSortBottomSheet({
    Key key,
...
class _Item extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Selector<AllProductsViewModel, WooStoreFilters>(
      ...
      builder: (context, filters, _) {
        return GestureDetector(
          onTap: () {
            ...
            final provider = Provider.of<AllProductsViewModel>(
              context,
              listen: false,
            );
            provider.setSortOption(sortOption);
            NavigationController.navigator.pop();
            provider.fetchDataWithFilter();
          },
          child: Container(
