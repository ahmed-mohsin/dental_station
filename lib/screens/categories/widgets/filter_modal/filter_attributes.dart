...
class _AttributeItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (final obj
        in Provider.of<CategoryProductsProvider>(context, listen: false)
            .categoryFilters
            .taxonomyQueryList) {
...
class _AttributeItemTerm extends StatelessWidget {
  ...
  Widget _buildSelector(Widget child) {
    return GestureDetector(
      onTap: () {
        LocatorService.categoryProductsProvider().setTaxonomyQuery(
      ...
      child: Selector<CategoryProductsProvider, WooStoreFilters>(
