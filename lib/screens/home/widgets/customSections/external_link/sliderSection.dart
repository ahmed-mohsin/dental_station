...
class SliderExternalLinkSectionProducts extends StatelessWidget {
  const SliderExternalLinkSectionProducts({
    Key key,
    @required this.sectionData,
  }) : super(key: key);

  final SliderExternalLinkSectionData sectionData;
...
class _CardItem extends StatelessWidget {
  ...
  final SliderExternalLinkSectionDataItem item;
