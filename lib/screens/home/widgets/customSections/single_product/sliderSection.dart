...
class SliderSingleProductSectionProducts extends StatelessWidget {
  const SliderSingleProductSectionProducts({
    Key key,
    @required this.sectionData,
  }) : super(key: key);

  final SliderSingleProductSectionData sectionData;
...
class _CardItem extends StatelessWidget {
  ...
  final SliderSingleProductSectionDataItem item;
