...
class AdvancedPromotionSingleProductSectionProducts extends StatelessWidget {
  const AdvancedPromotionSingleProductSectionProducts({
    Key key,
    @required this.sectionData,
  }) : super(key: key);
  final AdvancedPromotionSingleProductSectionData sectionData;
...
class _RowItem extends StatelessWidget {
  ...
  final AdvancedPromotionSingleProductSectionData sectionData;
  final AdvancedPromotionSingleProductSectionDataItem item;
    ...
    return GestureDetector(
      onTap: () {
        if (isBlank(item.productId)) {
          Dev.warn(
              'Advanced Promotion Single Product Section product Id is blank!');
        } else {
          NavigationController.navigator
              .push(ProductScreenRoute(id: item.productId));
        }
      },
      child: AspectRatio(
        aspectRatio: 1,
